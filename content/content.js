const CONFIG = {
    ...
    ICONS: {
        FORWARD: 'assets/PlayerIcons/alt-forward.png',
        REWIND: 'assets/PlayerIcons/alt-rewind.png'
    },
    IDS: {
...
function performSeek(skipTime) {
    ...
    const executeSeek = () => {
        try {
            ...
            }, state.settings.progressBarUpdateDelay);
        } catch (error) {
...
function handleNavigation() {
    ...
    if (isWatchPage()) {
         ...
         }, state.settings.navigationInitDelay);
    } else {
        removeButtons();
